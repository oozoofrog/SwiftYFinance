...
## Phase 2: Core Data Model (YFTickerTests.swift, YFPriceTests.swift, YFHistoricalDataTests.swift)
...
## Phase 3: Network Layer (YFSessionTests.swift, YFRequestBuilderTests.swift, YFResponseParserTests.swift)
...
## Phase 4: API Integration (YFClientTests.swift)
### Price History → YFClientTests.swift
- [x] testFetchPriceHistory1Day - 1일 데이터 조회
- [x] testFetchPriceHistory1Week - 1주 데이터 조회
- [x] testFetchPriceHistoryCustomRange - 사용자 지정 범위
- [x] testFetchPriceHistoryInvalidSymbol - 잘못된 심볼 처리
- [x] testFetchPriceHistoryEmptyResult - 빈 결과 처리

### Quote Data → YFClientTests.swift
- [x] testFetchQuoteBasic - 기본 시세 조회
- [x] testFetchQuoteRealtime - 실시간 시세 조회
- [x] testFetchQuoteAfterHours - 시간외 거래 데이터

### Fundamental Data → YFClientTests.swift
- [x] testFetchFinancials - 재무제표 조회
- [x] testFetchBalanceSheet - 대차대조표 조회
