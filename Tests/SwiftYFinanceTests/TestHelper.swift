...
///
/// ## 사용 예시 (@Suite 기반 자동 setUp/tearDown)
/// ```swift
/// @Suite("My Tests")
/// struct MyTests {
///     init() async {
...
///
///     deinit {
///         // Swift Testing에서 deinit은 동기이므로 Task 사용
///         // 또는 tearDown을 각 테스트 defer에서 호출
///     }
/// }
/// ```
struct TestHelper {
    ...
    static func clearAllYahooCookies() {
    ...
    static func clearCookies(for domain: String) {
        guard let cookies = HTTPCookieStorage.shared.cookies else { return }
