...
extension YFAPIURLBuilder {
    ...
    nonisolated struct ChartBuilder: Sendable {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func symbol(_ symbol: String) -> ChartBuilder {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func period(_ period: YFPeriod) -> ChartBuilder {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func interval(_ interval: YFInterval) -> ChartBuilder {
            var newParams = parameters
        ...
        ///   - endDate: 종료 날짜
        /// - Returns: 새로운 빌더 인스턴스
        func dateRange(from startDate: Date, to endDate: Date) -> ChartBuilder {
            var newParams = parameters
        ...
        ///   - value: 파라미터 값
        /// - Returns: 새로운 빌더 인스턴스
        func parameter(_ key: String, _ value: String) -> ChartBuilder {
            var newParams = parameters
            newParams[key] = value
            return ChartBuilder(session: session, symbol: symbol, parameters: newParams)
        }
