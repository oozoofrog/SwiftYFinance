...
extension YFAPIURLBuilder {
    ...
    nonisolated struct ScreenerBuilder: Sendable {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func predefined(_ screener: YFPredefinedScreener) -> ScreenerBuilder {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func count(_ count: Int) -> ScreenerBuilder {
            var newParams = parameters
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func language(_ lang: String) -> ScreenerBuilder {
            var newParams = parameters
            newParams["lang"] = lang
            return ScreenerBuilder(session: session, parameters: newParams)
        }
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func region(_ region: String) -> ScreenerBuilder {
            var newParams = parameters
        ...
        ///   - value: 파라미터 값
        /// - Returns: 새로운 빌더 인스턴스
        func parameter(_ key: String, _ value: String) -> ScreenerBuilder {
            var newParams = parameters
            newParams[key] = value
            return ScreenerBuilder(session: session, parameters: newParams)
        }
    ...
    /// Custom Screener API 전용 빌더 (내부 구현 타입)
    ///
    ...
    nonisolated struct CustomScreenerBuilder: Sendable {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func query(_ query: YFScreenerQuery) -> CustomScreenerBuilder {
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func count(_ count: Int) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func offset(_ offset: Int) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func sortField(_ field: String) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func sortOrder(ascending: Bool = false) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func userId(_ userId: String) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        /// - Returns: 새로운 빌더 인스턴스
        func userIdType(_ userIdType: String) -> CustomScreenerBuilder {
            var newBody = requestBody
        ...
        ///   - value: 파라미터 값
        /// - Returns: 새로운 빌더 인스턴스
        func parameter(_ key: String, _ value: Sendable) -> CustomScreenerBuilder {
            var newBody = requestBody
            newBody[key] = value
            return CustomScreenerBuilder(session: session, query: query, requestBody: newBody)
        }
        ...
        func getRequestBody() throws -> Data {
